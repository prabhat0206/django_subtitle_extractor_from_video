      ...
      <div className="flex h-20 flex-wrap place-items-start h-22 justify-end p-4 w-full">
        <div className="text-center">
          <button
            ...
            className="p-2 pl-5 pr-5 bg-transparent border-2 border-indigo-500 text-lg rounded-lg transition-colors duration-700 transform bg-indigo-500 text-gray-100 focus:border-4 focus:border-indigo-300"
          >
            Upload Video
          </button>
        </div>
